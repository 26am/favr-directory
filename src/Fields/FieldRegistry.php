...
final class FieldRegistry {
	...
	private static function definitions(): array {
		$fields = array(
			...
			array(
				'id'          => 'organization',
				'label'       => __( 'Organization / firm', 'favr-directory' ),
				'type'        => 'text',
				'tab'         => 'overview',
				'width'       => 'half',
				'placeholder' => __( 'For people: the firm, company or agency they work for', 'favr-directory' ),
				'maxlength'   => 120,
				'weight'      => 3,
			),
			array(
				'id'          => 'languages',
				'label'       => __( 'Languages spoken', 'favr-directory' ),
				'type'        => 'text',
				'tab'         => 'overview',
				'width'       => 'half',
				'placeholder' => __( 'e.g. Spanish, Vietnamese, Mandarin', 'favr-directory' ),
				'description' => __( 'Separate with commas. Shown as tags and searchable.', 'favr-directory' ),
				'maxlength'   => 200,
				'weight'      => 3,
			),
			array(
				'id'          => 'sort_name',
				'label'       => __( 'Sort as', 'favr-directory' ),
				'type'        => 'text',
				'tab'         => 'overview',
				'width'       => 'half',
				'placeholder' => __( 'Optional, e.g. “Nguyen Rogers, Camlinh”', 'favr-directory' ),
				'description' => __( 'How this listing is alphabetized. People directories sort by last name automatically.', 'favr-directory' ),
				'maxlength'   => 120,
				'private'     => true,
			),
			array(
